/**
 * The <code>AudioPlayer</code> thread class will simply download and play
...
import wa.util.NotifyingThread;
...
public class AudioPlayer extends NotifyingThread {
	...
	public boolean shouldPrompt = false;
	...
	public static void main(String[] args)
	{
		...
		if(url != null)
		{
			AudioPlayer examplePlayer = new AudioPlayer(url);
			examplePlayer.start();
		}
		else
		{
	 ...
	 */
	public AudioPlayer(String pUrl)
	{
	...
	private boolean initializeSound()
	{
		...
		{
			LOG.error("The audio output line could not be opened due to resource restrictions.", exception);
			return false;
		}
		catch(IllegalStateException exception)
		{
		    LOG.error("The audio output line is already open.", exception);
			return false;
		}
		catch(SecurityException exception)
		{
		    LOG.error("The audio output line could not be opened due to security restrictions.", exception);
			return false;
		}
	...
	private void readBody()
	{
		...
		while(needMoreData)
		{
			...
			if(needMoreData)
			{
				...
				{
					LOG.error("read:" + count + ", buffersize:" + bufferSize + ", index:" + index, e);
					return;
				}
